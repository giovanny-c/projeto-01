...
class GetDonationController {
    ...
    async handle(req: Request, res: Response): Promise<any> {
        ...
        return res.status(200).render("views/donations/donation", {formated_value, formated_date, donation, ngo, file_name, messages, error: req.error, success: req.success })
    }
}
