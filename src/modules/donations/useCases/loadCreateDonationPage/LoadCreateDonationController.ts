...
class LoadCreateDonationController {
    ...
    async handle(req: Request, res: Response): Promise<any> {
        ...
        return res.status(200).render("views/donations/create-donation", {ngo, ngo_donation_counter, ngos: req.ngos, workers, date, username: req.user.name, error: req.error, success: req.success})
