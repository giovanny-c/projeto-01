...
class PDF_LIBFileProvider implements IFileProvider {
    ...
    async generateFileForBooklet(donation: Donation, saveFile: boolean): Promise<Uint8Array> {
        ...
        const pdfBytes = await receiptProvider.generateReceiptForBooklet(doc, donation, saveFile, template, templateSign, font)
